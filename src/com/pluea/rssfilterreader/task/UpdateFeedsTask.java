 ...
 */
public class UpdateFeedsTask extends
		AsyncTask<ArrayList<Feed>, String, Boolean> {
	...
	private static final String LOG_TAG = "RSS_READER."
			+ UpdateFeedsTask.class.getName();
	...
	public static UpdateFeedsTask getInstance(Context context,
	...
	protected void onPostExecute(Boolean result) {
		if (result) {
			if (!feeds.isEmpty() && showProgress) {
				Toast.makeText(context_, R.string.article_updated,
						Toast.LENGTH_SHORT).show();
			}
		} else if (showProgress) {
			Toast.makeText(context_, R.string.article_update_error,
					Toast.LENGTH_SHORT).show();
		}

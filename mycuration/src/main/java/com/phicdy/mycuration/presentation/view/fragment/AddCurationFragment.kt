...
class AddCurationFragment : Fragment(), AddCurationView {
    ...
    override fun handleSameNameCurationError() {
        ...
        msg.data = bundle
        handler.sendMessage(msg)
        GATrackerHelper.sendButtonEvent(getString(R.string.add_same_curation_name))
    }
    ...
    override fun handleAddSuccess() {
        ...
        msg.obj = true
        handler.sendMessage(msg)
        GATrackerHelper.sendButtonEvent(getString(R.string.add_new_curation))
    }
    ...
    override fun handleEditSuccess() {
        ...
        msg.obj = true
        handler.sendMessage(msg)
        GATrackerHelper.sendButtonEvent(getString(R.string.update_curation))
    }
